...
const $$Purchases = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Purchases;
  const pageTitle = "\u0417\u0430\u043A\u0443\u043F\u043A\u0438";
                ...
                <div class="article">
                    ...
                    <div class="article__text article__text--cols">
                        <p>ГАУ Московской области &laquo;Мособлгосэкспертиза&raquo; осуществляется закупки товаров и&nbsp;услуг на&nbsp;основании <br>
                            <a href="https://www.consultant.ru/document/cons_doc_LAW_116964/" target="_blank">223-го ФЗ</a>
                            &nbsp;на&nbsp;различных площадках для торгов, в&nbsp;частности 
                            <a href="https://www.rts-tender.ru/" target="_blank">&laquo;РТС-Тендер&raquo;.</a>
                        </p>
                    </div>
                </div>
            </div>
...
` })}`;
}, "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/purchases.astro", void 0);

const $$file = "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/purchases.astro";
const $$url = "/purchases.html";

export { $$Purchases as default, $$file as file, $$url as url };
