...
const $$PricingMain = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$PricingMain;
  const pageTitle = "\u0426\u0415\u041D\u041E\u041E\u0411\u0420\u0410\u0417\u041E\u0412\u0410\u041D\u0418\u0415";
  const category = {
        ...
        <div class="content">
            <div class="content__left-block">
                <picture class="content__picture">
                    <source srcset="images/pricing/image_1.webp">
                    <img src="images/pricing/image_1.jpg" alt="" width="" height="">
                </picture>
                <div class="article">
                    <h1>Управление ценообразования в&nbsp;строительстве является самостоятельным структурным подразделением, входящим в&nbsp;состав ГАУ МО&nbsp;&laquo;Мособлгосэкспертиза&raquo;.</h1>
                    <div class="article__text article__text--cols">
                        <p>Управление ценообразования в&nbsp;строительстве осуществляет свою деятельность по&nbsp;следующим основным направлениям:</p>
                        <ul>
                            <li>проведение проверки сметной документации и&nbsp;актов выполненных работ на&nbsp;новое строительство, реконструкцию и&nbsp;капитальный ремонт зданий, сооружений и&nbsp;инженерных сетей, расположенных на&nbsp;территории Московской области;</li>
                            <li> формирование и&nbsp;совершенствование региональной системы ценообразования и&nbsp;сметного нормирования, разработка методических рекомендаций, инструкций и&nbsp;правил по&nbsp;ценообразованию в&nbsp;строительстве, оказание информационной и&nbsp;методической помощи в&nbsp;сметном деле;</li>
                            <li>разработка ежемесячных Сборников расчетных индексов пересчета стоимости строительных, специальных строительных, ремонтно-строительных, монтажных и&nbsp;пуско-наладочных работ для Московской области к&nbsp;ценам 2000&nbsp;г.&nbsp;и&nbsp;по&nbsp;индивидуальным заявкам к&nbsp;ценам 1984&nbsp;г.;</li>
                            <li>подготовка и&nbsp;предоставление отчетных данных о&nbsp;динамике цен на&nbsp;ресурсы и&nbsp;готовую строительную продукцию, а&nbsp;также о&nbsp;динамике индексов пересчета стоимости строительно-монтажных работ.</li>
                        </ul>
...
` })}`;
}, "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/pricing-main.astro", void 0);

const $$file = "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/pricing-main.astro";
const $$url = "/pricing-main.html";

export { $$PricingMain as default, $$file as file, $$url as url };
