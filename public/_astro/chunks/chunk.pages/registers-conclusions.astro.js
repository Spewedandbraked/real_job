...
const $$RegistersConclusions = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$RegistersConclusions;
  const pageTitle = "\u0420\u0435\u0435\u0441\u0442\u0440\u044B \u0437\u0430\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0439";
        ...
        <div class="content">
            <div class="content__left-block">
                <picture class="content__picture">
                    <source srcset="images/documents/image_1.webp">
                    <img src="images/documents/image_1.jpg" alt="" width="" height="">
                </picture>
                <div class="article">
                    <h2>Реестры заключений</h2>
                    <div class="article__text article__text--cols">
                        <p>ГАУ Московской области &laquo;Мособлгосэкспертиза&raquo; своевременно информирует о&nbsp;выпуске заключений экспертизы, ведет и&nbsp;публикует на&nbsp;официальном сайте реестры своих заключений по&nbsp;своем видам экспертизы.</p>
                    </div>
                </div>
            </div>
        </div>
...
` })}`;
}, "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/registers-conclusions.astro", void 0);

const $$file = "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/registers-conclusions.astro";
const $$url = "/registers-conclusions.html";

export { $$RegistersConclusions as default, $$file as file, $$url as url };
