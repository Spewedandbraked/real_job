...
const $$Regulations = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Regulations;
  const pageTitle = "\u0420\u0435\u0433\u043B\u0430\u043C\u0435\u043D\u0442\u044B \u043E\u043A\u0430\u0437\u0430\u043D\u0438\u044F \u0443\u0441\u043B\u0443\u0433";
        ...
        <div class="content">
            <div class="content__left-block">
                <picture class="content__picture">
                    <source srcset="images/documents/image_2.webp">
                    <img src="images/documents/image_2.jpg" alt="" width="" height="">
                </picture>
                <div class="article">
                    <h2>Регламенты оказания услуг</h2>

                    <div class="article__text article__text--cols">
                        Все основные услуги, оказываемые ГАУ Московской области &laquo;Мособлгосэкспертизы&raquo;, имеют регламенты оказания, а&nbsp;также оказываются в&nbsp;соответствии с&nbsp;внутренними нормативными актами, изданными учреждением, определяющими порядок оказания тех или иных услуг.
                    </div>
                </div>
            </div>
        </div>
...
` })}`;
}, "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/regulations.astro", void 0);

const $$file = "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/regulations.astro";
const $$url = "/regulations.html";

export { $$Regulations as default, $$file as file, $$url as url };
