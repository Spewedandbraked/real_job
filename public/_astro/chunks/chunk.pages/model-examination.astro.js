...
const $$ModelExamination = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$ModelExamination;
  const pageTitle = "\u0413\u043E\u0441\u0443\u0434\u0430\u0440\u0441\u0442\u0432\u0435\u043D\u043D\u0430\u044F \u044D\u043A\u0441\u043F\u0435\u0440\u0442\u0438\u0437\u0430 \u0446\u0438\u0444\u0440\u043E\u0432\u044B\u0445 \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u043E\u043D\u043D\u044B\u0445 \u043C\u043E\u0434\u0435\u043B\u0435\u0439";
        ...
        <div class="content">
            <div class="content__left-block">
                <div class="content__block">
                    <div class="article">
                        <h1>Государственная экспертиза цифровых информационных моделей</h1>
                        <div class="article__text article__text--cols">
                            <p>Постановлением от&nbsp;17.05.2024 &#8470;&nbsp;614 &laquo;Об&nbsp;утверждении Правил формирования и&nbsp;ведения информационной модели объекта капитального строительства, состава сведений, документов и&nbsp;материалов, включаемых в&nbsp;информационную модель (ИМ) объекта капитального строительства и&nbsp;представляемых в&nbsp;форме электронных документов, и&nbsp;требований к&nbsp;форматам указанных электронных документов&raquo;, вступающим в&nbsp;силу 01&nbsp;сентября 2024, утверждены:</p>
                            <p>Правила формирования и&nbsp;ведения информационной модели объекта капитального строительства;Состав сведений, документов и&nbsp;материалов, включаемых в&nbsp;информационную модель объекта капитального строительства и&nbsp;представляемых в&nbsp;форме электронных документов, и&nbsp;требования к&nbsp;форматам указанных электронных документов.</p>
                        </div>
                    </div> 
                </div>
                <div class="content__block">
...
` })}`;
}, "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/model-examination.astro", void 0);

const $$file = "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/model-examination.astro";
const $$url = "/model-examination.html";

export { $$ModelExamination as default, $$file as file, $$url as url };
