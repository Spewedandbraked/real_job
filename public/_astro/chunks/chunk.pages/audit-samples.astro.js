import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent, s as spreadAttributes, F as Fragment } from '../chunk.astro.js';
...
const $$Materials = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { materials } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`materials ${materials.document ? "materials--document" : ""} ${materials.side ? "materials--side" : ""}`, "class")}>
    <div class="materials__list">
        ${materials.list.map((item) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${item.document ? renderTemplate`<a${addAttribute(item.href, "href")}${addAttribute(`materials__item ${item.document && "materials__item--document"}`, "class")} title=""${spreadAttributes(item.pdf && { download: item.pdf, target: "_blank" })}>
                        <span class="materials__content">
                            ${item.text}
                            ${item.content ? renderTemplate`<span class="materials__text">${item.content}</span>` : ""}
                        </span>
                        ${item.pdf ? renderTemplate`<span>pdf</span>` : renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "arrrow-right", "mod": "" })}`}
                    </a>` : renderTemplate`<a${addAttribute(item.href, "href")}${addAttribute(`materials__item ${item.main && "materials__item--main"} ${item.active ? "active" : ""}`, "class")} title=""${spreadAttributes(item.pdf && { download: item.pdf, target: "_blank" })}>
                        ${item.text}
                        ${item.pdf ? renderTemplate`<span>pdf</span>` : renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "arrrow-right", "mod": "" })}`}
                        ${item.zip ? renderTemplate`<span>zip</span>` : ""}
                    </a>`}` })}`)}
    </div>
</div>`;
}, "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/components/Materials/Materials.astro", void 0);

const $$Astro = createAstro();
const $$AuditSamples = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$AuditSamples;
  const pageTitle = "\u041E\u0431\u0440\u0430\u0437\u0446\u044B \u0434\u043E\u043A\u0443\u043C\u0435\u043D\u0442\u043E\u0432 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F \u0443\u0441\u043B\u0443\u0433\u0438 \u0442\u0435\u0445\u043D\u043E\u043B\u043E\u0433\u0438\u0447\u0435\u0441\u043A\u043E\u0433\u043E \u0438 \u0446\u0435\u043D\u043E\u0432\u043E\u0433\u043E \u0430\u0443\u0434\u0438\u0442\u0430 \u043F\u0443\u0431\u043B\u0438\u0447\u043D\u044B\u0445 \u0438\u043D\u0432\u0435\u0441\u0442\u0438\u0446\u0438\u043E\u043D\u043D\u044B\u0445 \u043F\u0440\u043E\u0435\u043A\u0442\u043E\u0432";
  ...
  const materials = {
    list: [
      {
        text: "\u041F\u0440\u0438\u043C\u0435\u0440 \u043E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u044F \u0437\u0430\u044F\u0432\u043B\u0435\u043D\u0438\u044F \u043D\u0430 \u043F\u0440\u043E\u0432\u0435\u0434\u0435\u043D\u0438\u0435 \u0442\u0435\u0445\u043D\u043E\u043B\u043E\u0433\u0438\u0447\u0435\u0441\u043A\u043E\u0433\u043E \u0438 \u0446\u0435\u043D\u043E\u0432\u043E\u0433\u043E \u0430\u0443\u0434\u0438\u0442\u0430 \u043F\u0443\u0431\u043B\u0438\u0447\u043D\u043E\u0433\u043E \u0438\u043D\u0432\u0435\u0441\u0442\u0438\u0446\u0438\u043E\u043D\u043D\u043E\u0433\u043E \u043F\u0440\u043E\u0435\u043A\u0442\u0430",
        href: "javascript:void(0);",
        pdf: true
      }
    ]
    ...
    <div class="container container--small">
        <div class="content">
            <div class="content__left-block">
                <div class="article">
                    <h1>Образцы документов пользователя услуги технологического и&nbsp;ценового аудита публичных инвестиционных проектов</h1>
                </div>
...
` })}`;
}, "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/audit-samples.astro", void 0);

const $$file = "/Users/mellblimm/worksOwn/xpert/the-devs-moge/src/pages/audit-samples.astro";
const $$url = "/audit-samples.html";

const auditSamples = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    default: $$AuditSamples,
    file: $$file,
    url: $$url
}, Symbol.toStringTag, { value: 'Module' }));

export { $$Materials as $, auditSamples as a };
